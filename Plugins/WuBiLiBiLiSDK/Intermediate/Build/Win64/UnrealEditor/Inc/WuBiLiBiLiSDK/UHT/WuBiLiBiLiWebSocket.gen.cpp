...
// End Cross Module References
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UWuBiLiBiLiWebSocket_Statics::Class_MetaDataParams[] = {
...
#endif
	const FCppClassTypeInfoStatic Z_Construct_UClass_UWuBiLiBiLiWebSocket_Statics::StaticCppClassTypeInfo = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_BiLiBiLiProject_Plugins_WuBiLiBiLiSDK_Source_WuBiLiBiLiSDK_Public_WuBiLiBiLiWebSocket_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UWuBiLiBiLiWebSocket, UWuBiLiBiLiWebSocket::StaticClass, TEXT("UWuBiLiBiLiWebSocket"), &Z_Registration_Info_UClass_UWuBiLiBiLiWebSocket, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UWuBiLiBiLiWebSocket), 964252342U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_BiLiBiLiProject_Plugins_WuBiLiBiLiSDK_Source_WuBiLiBiLiSDK_Public_WuBiLiBiLiWebSocket_h_4042683495(TEXT("/Script/WuBiLiBiLiSDK"),
